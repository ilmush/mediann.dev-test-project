...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='shop_specif_name_9a94f4_idx')],
            },
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(blank=True, null=True, related_name='related_customer', to='shop.order'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
